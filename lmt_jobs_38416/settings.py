"""
Django settings for lmt_jobs_38416 project.
...
ROOT_URLCONF = 'lmt_jobs_38416.urls'
...
WSGI_APPLICATION = 'lmt_jobs_38416.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lmt_jobs_38416 API",
    "DESCRIPTION": "API documentation for lmt_jobs_38416 App",
    "VERSION": "v1",
}
